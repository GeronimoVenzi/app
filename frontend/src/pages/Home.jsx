...
const Home = () => {
  ...
  return (
    <div className="bg-black text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  En <b>Cinegata</b> nos dedicamos al cine de género y a las voces autorales que buscan empujar los límites.
                  Creemos en las ideas raras, en las miradas frescas y en las películas que pueden viajar lejos sin perder su identidad.
                  Desarrollamos y producimos proyectos originales con potencial internacional, y trabajamos junto a aliados estratégicos para acompañar su distribución, sus ventas y su recorrido por festivales.
      ...
      <section id='trailer' className="py-24 px-4 bg-black relative overflow-hidden">
        {/* Background texture */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }}>
              ...
              {/* CTA Buttons - Elimina el botón "Ver Trailer" ya que el video está visible arriba */}
      ...
      <section className="py-24 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-red-600">Rodaje</span>
            </h2>
            <div className="w-24 h-1 bg-red-600 mx-auto mb-8" />
          </motion.div>
